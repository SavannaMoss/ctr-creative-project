  ...
  public static works: Work[] = [
    {
      ...
      description: '',
      source: '',
      tags: ['race', 'racism', 'feminism', 'sexism', 'misogyny', 'privilege', 'gender', 'anti-Black racism']
    },
    {
      ...
      description: '',
      source: '',
      tags: ['race', 'racism', 'prejudice', 'anti-Black racism']
    },
    {
      ...
      description: '',
      source: '',
      tags: ['race', 'racism', 'philosophy', 'class', 'rationality', 'identity', 'morality', 'anti-Black racism']
    },
    {
      ...
      tags: ['race', 'racism', 'feminism', 'sexism', 'misogyny', 'gender', 'anti-Black racism']
    },
    {
      ...
      tags: ['race', 'racism', 'double-consciousness', 'ontology', 'white gaze', 'identity', 'anti-Black racism']
    },
    {
      ...
      description: '',
      source: '',
      tags: ['race', 'racism', 'double-consciousness', 'rationality', 'identity', 'person vs subperson', 'anti-Black racism']
    },
    {
      ...
      tags: ['race', 'racism', 'rationality', 'philosophy', 'society', 'justice', 'class', 'ontology', 'white supremacy', 'epistemology', 'morality', 'norming/normalization/naturalization', 'person vs subperson', 'privilege', 'empathy', 'anti-Black racism']
    },
    {
      ...
      tags: ['race', 'racism', 'phenomenology', 'ontology', 'philosophy', 'white gaze', 'double-consciousness', 'norming/normalization/naturalization', 'hypervisibility vs invisibility', 'identity', 'docility', 'objectification', 'white supremacy', 'empathy', 'white racist imaginary', 'anti-Black racism']
    },
    {
      ...
      tags: ['race', 'racism', 'feminism', 'sexism', 'misogyny', 'gender', 'intersectionality', 'objectification', 'sexual exploitation', 'othering', 'patriarchy', 'docility', 'anti-Black racism']
    },
    {
      ...
      source: '',
      tags: ['race', 'racism', 'feminism', 'sexism', 'misogyny', 'intersectionality', 'law', 'philosophy', 'gender', 'patriarchy', 'politics', 'identity', 'anti-Black racism']
    },
    {
      ...
      tags: ['race', 'racism', 'phenomenology', 'anti-Asian racism', 'philosophy', 'politics', 'white racist imaginary', 'morality', 'norming/normalization/naturalization', 'hypervisibility vs invisibility', 'objectification', 'white gaze']
    },
    {
      ...
      tags: ['race', 'racism', 'phenomenology', 'philosophy', 'norming/normalization/naturalization', 'white gaze', 'racializing vision', 'double-consciousness', 'patriarchy', 'gender', 'sexism', 'objectification', 'anti-Muslim racism']
    }
  ];
